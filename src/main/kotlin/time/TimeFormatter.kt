...
private const val minuteInSeconds = 60 * second
private const val hourInSeconds = minuteInSeconds * 60
private const val dayInSeconds = hourInSeconds * 24
private const val yearInSeconds = dayInSeconds * 365
...
private fun formatUnits(unitkey: String, unitvalue: Int): String = "$unitvalue $unitkey" + plural(unitvalue)
